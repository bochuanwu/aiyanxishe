...
class VGG_FeatureExtractor(nn.Module):
    ...
    def __init__(self, input_channel, output_channel=512):
        ...
        self.ConvNet = nn.Sequential(
            nn.Conv2d(input_channel, self.output_channel[0], 3, 1, 1), nn.LeakyReLU(0.2, inplace=True),
            nn.MaxPool2d(2, 2),  # 64x16x50
            nn.Conv2d(self.output_channel[0], self.output_channel[1], 3, 1, 1), nn.LeakyReLU(0.2, inplace=True),
            nn.MaxPool2d(2, 2),  # 128x8x25
            nn.Conv2d(self.output_channel[1], self.output_channel[2], 3, 1, 1), nn.LeakyReLU(0.2, inplace=True),  # 256x8x25
            nn.Conv2d(self.output_channel[2], self.output_channel[2], 3, 1, 1), nn.LeakyReLU(0.2, inplace=True),
            nn.MaxPool2d((2, 1), (2, 1)),  # 256x4x25
            nn.Conv2d(self.output_channel[2], self.output_channel[3], 3, 1, 1, bias=False),
            nn.BatchNorm2d(self.output_channel[3]), nn.LeakyReLU(0.2, inplace=True),  # 512x4x25
            nn.Conv2d(self.output_channel[3], self.output_channel[3], 3, 1, 1, bias=False),
            nn.BatchNorm2d(self.output_channel[3]), nn.LeakyReLU(0.2, inplace=True),
            nn.MaxPool2d((2, 1), (2, 1)),  # 512x2x25
            nn.Conv2d(self.output_channel[3], self.output_channel[3], 2, 1, 0), nn.LeakyReLU(0.2, inplace=True))  # 512x1x24
...
class GRCL(nn.Module):
    ...
    def forward(self, input):
        ...
        #x = F.LeakyReLU(self.BN_x_init(wf_u))
...
class GRCL_unit(nn.Module):
    ...
    def forward(self, wgf_u, wgr_x, wf_u, wr_x):
        ...
        #x = F.LeakyReLU(x_first_term + x_second_term)
