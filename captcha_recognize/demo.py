...
def parse_arg():
    ...
    parser.add_argument('--image_path', type=str, default='./images/test/', help='the path to your image')
    parser.add_argument('--checkpoint', type=str, default='output/OWN/crnn/2020-05-28-17-00/checkpoints/checkpoint_119_acc_0.7839.pth',
